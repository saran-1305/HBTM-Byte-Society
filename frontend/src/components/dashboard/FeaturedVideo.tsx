...
const FeaturedVideo = () => {
  return (
    <div className="bg-[#131826] p-6 rounded-[20px] shadow-[0_2px_8px_rgba(0,0,0,0.06)] border border-[#1F2937] w-full flex flex-col">
      <div className="flex justify-between items-start mb-4">
        <div>
          ...
          <h2 className="text-[20px] font-bold text-[#3A2E27] mt-2">System Design Interview in 40 Minutes</h2>
          <p className="text-[13px] text-[#9CA3AF]">Alex Xu • 40 mins</p>
        </div>
      </div>

      {/* Video Player Container */}
      <div className="relative w-full aspect-video bg-[#0B0F1A] rounded-full overflow-hidden border border-[#1F2937] mb-4 shadow-lg group">
        <iframe 
      ...
      {/* Context/Reasoning */}
      <div className="bg-[#0B0F1A] border border-[#1F2937] rounded-full p-4 flex gap-3 items-start">
        <Info className="w-5 h-5 text-[#6366F1] shrink-0 mt-0.5" />
        <div>
          <h4 className="text-[13px] font-semibold text-[#3A2E27] mb-1">Why this, why now?</h4>
